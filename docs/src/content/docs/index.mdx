...
**[FastAPI resource scaffolding](/examples/fastapi-endpoint/)** — Adding a new resource to a FastAPI app means a router, Pydantic schemas, and a test. The resource name appears in class names, route paths, function names, and imports. Generate all three files at once from a single prompt.
